                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <img src="https://images.pexels.com/photos/2962282/pexels-photo-2962282.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" className="img-fuid rounded-start" alt="..."/>
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body text-start mt-2">
                                        ...
                                        <h5 className="card-text">Termal Feeling: {(weather.main.feels_like - 273.15).toFixed(1)}ºC</h5>   
                                        <h5 className="card-text">Humidity: {weather.main.humidity}%</h5>   
                                        <h5 className="card-text">Wind Speed: {weather.main.wind.speed}m/s</h5>                           
                                    </div>
                                    <hr/>
